...
const avatarUrl = `https://avataaars.io/?avatarStyle=${avatarStyle}&topType=${topType1}&accessoriesType=${accessoriesType1}&hairColor=${hairColor1}&facialHairType=${facialHairType1}&facialHairColor=${facialHairColor1}&clotheType=${clotheType1}&clotheColor=${clotheColor1}&eyeType=${eyeType1}&eyebrowType=${eyebrowType1}`;
